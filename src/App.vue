<template>
  ...
  <div class="max-w-lg m-auto">
    <h1 class="text-2xl font-mono">Blace.io</h1>
    <h2 class="text-xl mb-4">The Cardano Marketplace Creator</h2>
    <p class="mb-4">
      How can we create a positive developer experience that helps the developer focus on building successful decentralized applications?
    </p>
    <p class="mb-4">
      This is the leading question that led us to the development of <strong>blace</strong>.
    </p>
    <p class="mb-4">
